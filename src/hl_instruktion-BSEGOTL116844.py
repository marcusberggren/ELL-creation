...
def create_dataframe():
    ...
    df.columns = ['BOOKING NUMBER', 'PORT', 'TOL', 'CONTAINER', 'ISO TYPE', 'NET WEIGHT', 'VGM', 'PO NUMBER', 
    'NO. OF PACKAGES', 'GOODS DESCRIPTION', 'OCEAN VESSEL', 'VOY']

    df_info_sheet = pd.DataFrame(columns=['BOOKING NUMBER', 'MLO', 'PORT', 'TERMINAL', 'CONTAINER', 'ISO TYPE',
    'NET WEIGHT', 'POD STATUS', 'LOAD STATUS', 'VGM', 'OOG', 'IMDG', 'UNNR', 'CHEM REF', 'MRN', 'TEMP',
